    ...
    return SingleChildScrollView(
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: widget.formType == FormType.email
              ? "username@gmail.com"
              : widget.formType == FormType.password
                  ? "Input more than 8"
                  : "Tet Davann",
          labelStyle: Theme.of(context).textTheme.displayMedium,
          labelText: "${widget.formType}",
          suffix: widget.formType == FormType.password
              ? GestureDetector(
              ...
              : const SizedBox(),
          hintStyle: const TextStyle(color: MaterialColors.four),
